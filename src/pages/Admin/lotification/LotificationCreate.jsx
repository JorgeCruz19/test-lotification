...
const schema = yup.object().shape({
	name: yup
		...
		.required("El campo nombre de lotificacion es obligatorio"),
});

const LotificationCreate = () => {
	const {
		register,
		handleSubmit,
		reset,
	...
	const onSubmit = async (data) => {
		...
		setLoading(false);
		reset({ name: "" });
		toast.success("Se agregó la lotificación correctamente");
	};
		...
		<>
			<div className="w-full md:w-2/3 mx-auto">
				<h2 className="mb-8 font-bold text-2xl">
					Elije el departamento y ciudad a crear la lotificación
				</h2>
						...
						<form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
							<div className="mb-6">
								...
								<input
									...
									placeholder="Ingresa el nombre de la lotificación"
								/>
								{errors.name && (
...
export default LotificationCreate;
