		...
		<>
			{isLoading ? (
				...
				<div className="w-full md:w-2/3 mx-auto">
					<h2 className="mb-8 font-bold text-2xl">Lista de Departamentos</h2>
					<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
						<table className="w-full text-sm text-left text-gray-500 ">
							...
							<tbody>
								{departments.length ? departments.map(({ id, data }) => (
									<tr
										key={id}
								...
								:
								<tr>
									<td className="p-3 text-center" colSpan={2}>No hay departamentos registrados</td>
								</tr>
							}
							</tbody>
						</table>
