...
const schema = yup.object().shape({
	...
	password: yup
		...
		.min(6, "Su contraseña debe tener mínimo ${min} caracteres"),
});
...
const CreateUser = () => {
	...
	const onSubmit = async (data) => {
		try {
			...
			if (error.code === "auth/email-already-in-use") {
				toast.error("Ya hay un usuario registrado con estas credenciales");
			}
			setIsLoading(false);
		}
	};
	...
	return (
		<section className="w-full md:w-2/3 mx-auto">
			<h2 className="mb-8 font-bold text-2xl">Crear Usuario</h2>
			<form
